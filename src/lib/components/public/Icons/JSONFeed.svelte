...
<BaseIcon {...props}>
	<svg viewBox="0 0 140 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			...
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					<g id="icon" transform="translate(-4.000000, -14.000000)">
							<rect id="background" fill="none" x="4" y="14" width="140" height="140"></rect>
	...
	<!-- JSONFeed logo by Craig Hockenberry, part of the JSONFeed spec, licensed CC0 https://github.com/manton/JSONFeed -->
</BaseIcon>